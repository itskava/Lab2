...
// Функция, предназначенная для аллокации памяти для объекта структуры Timestamp и возвращающая указатель на нее. 
...
// Функция, предназначенная для деаллокации памяти объекта структуры Timestamp.
...
// Функция, предназначенная для аллокации памяти для объекта структуры Route и возвращающая указатель на нее.
Route* createRoute(
	int ticket_price,
...
// Функция, предназначенная для деаллокации памяти объекта структуры Route.
...
// Функция, предназначенная для аллокации памяти для объекта структуры Account и возвращающая указатель на нее.
...
// Функция, предназначенная для деаллокации памяти объекта структуры Account.
...
// Функция, предназначенная для аллокации памяти для объекта структуры FlightBookingService
...
// Функция, предназначенная для деаллокации памяти объекта структуры FlightBookingService.
...
int main(void) {
	...
	char name[50], email[50], telephone[20];
	int age, balance;
	printf("Введите Ваше ФИО: ");
	gets_s(name, sizeof(name) - 1);
	printf("Введите Вашу почту: ");
	gets_s(email, sizeof(email) - 1);
	printf("Введите Ваш телефон: ");
	gets_s(telephone, sizeof(telephone) - 1);
	printf("Введите Ваш возраст: ");
	scanf("%d", &age);
	printf("Введите сумму, на которую будет сразу пополнен Ваш счёт: ");
 	scanf("%d", &balance);

	FlightBookingService* fbs = createFlightBookingService(name, email, telephone, age, balance); // Создаем сам сервис
